...
class $AssetsIconsGen {
  ...
  /// List of all assets
  List<String> get values => [marker];
}

class $AssetsImagesGen {
  const $AssetsImagesGen();

  /// File path: assets/images/onBoardImage.png
  AssetGenImage get onBoardImage =>
      const AssetGenImage('assets/images/onBoardImage.png');

  /// List of all assets
  List<AssetGenImage> get values => [onBoardImage];
}

class $AssetsJsonGen {
  const $AssetsJsonGen();

  $AssetsJsonMainGen get main => const $AssetsJsonMainGen();
}

class $AssetsJsonMainGen {
  const $AssetsJsonMainGen();

  /// File path: assets/json/main/asia.json
  String get asia => 'assets/json/main/asia.json';

  /// File path: assets/json/main/europe.json
  String get europe => 'assets/json/main/europe.json';

  /// File path: assets/json/main/featured.json
  String get featured => 'assets/json/main/featured.json';

  /// File path: assets/json/main/mostvisited.json
  String get mostvisited => 'assets/json/main/mostvisited.json';

  /// File path: assets/json/main/popular.json
  String get popular => 'assets/json/main/popular.json';

  /// File path: assets/json/main/recommended.json
  String get recommended => 'assets/json/main/recommended.json';

  /// List of all assets
  List<String> get values =>
      [asia, europe, featured, mostvisited, popular, recommended];
}
