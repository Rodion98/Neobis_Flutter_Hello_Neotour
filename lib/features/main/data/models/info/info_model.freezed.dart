...
abstract class $InfoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String page, int count, String next, String previous});
}
...
class _$InfoModelImpl with DiagnosticableTreeMixin implements _InfoModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'InfoModel(page: $page, count: $count, next: $next, previous: $previous)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, page, count, next, previous);
...
abstract class _InfoModel implements InfoModel {
  const factory _InfoModel(
      ...
      required final String previous}) = _$InfoModelImpl;
